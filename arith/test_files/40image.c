...
void init_floats_from_rgb_ints(void *elem, Pnm_rgb pix_val)
{
        ...
        curr_pix->r_Y = (float)pix_val->red / 255;
        curr_pix->g_Pb = (float)pix_val->green / 255;
        curr_pix->b_Pr = (float)pix_val->blue / 255;        
...
*/
        ...
        int_pix->red = (int)(float_rgb->r_Y * 255);
        int_pix->green = (int)(float_rgb->g_Pb * 255);
        int_pix->blue = (int)(float_rgb->b_Pr * 255);
/*
